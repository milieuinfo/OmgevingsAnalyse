...
class mapTool(QgsMapTool):
    ...
    def canvasReleaseEvent(self,e):
        ...
        mkr = addMarker(self.iface, point)
        self.callback(mkr, point)
...
class lineTool(QgsMapTool):
    ...
    def canvasMoveEvent(self, e):
        ...
        self.rubberBand.setToGeometry(QgsGeometry.fromPolyline( self.points + [self.toMapCoordinates(e.pos())] ), None)
...
class polyTool(QgsMapTool):
    def __init__(self, iface, callback):
        ...
        self.rubberBand = QgsRubberBand(self.canvas, False)
        self.points = []
        self.rubberBand.setBorderColor(Qt.green)
        self.rubberBand.setWidth(1.6)
