...
class Ui_OmgevingsAnalyseDlg(object):
    def setupUi(self, OmgevingsAnalyseDlg):
        ...
        self.verticalLayout_3.addWidget(self.adresSelectionList)
        ...
        self.verticalLayout.addWidget(self.inputLocationTabs)
    ...
    def retranslateUi(self, OmgevingsAnalyseDlg):
        ...
        self.adresInputText.setPlaceholderText(_translate("OmgevingsAnalyseDlg", "<straat> <huisnr> , <gemeente of postcode>", None))
